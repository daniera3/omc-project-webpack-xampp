    ...
    return (
      ...
      <S.Content>
        ...
        <S.Form className='form-group'>
          ...
          <Select label='Users' options={this.state.userList} value={this.state.selectedUser} setValue={this.setSelectedUser.bind(this)} def={this.state.selectedUser} />
          <Select label='Permissions' options={this.permissionsOptions} value={this.state.parmission} setValue={this.setParmission.bind(this)} def={this.state.parmission} />
